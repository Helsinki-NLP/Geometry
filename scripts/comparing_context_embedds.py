...
def get_encodings_from_onmt_model(sents, opt):
    #################### TAKE AWAY!!!!!!!:
    opt.model = "/scratch/project_2001970/AleModel/tr.6l.8ah.en-de_step_200000.pt" # TAKE AWAY overwrite
    opt.bpe_model = "/scratch/project_2001970/AleModel/bpe-model.de-en-35k.wmt19-news-para.norm.tok.tc" # TAKE AWAY overwrite
    #--------------
    ...
    if opt.apply_bpe:
        sents = apply_bpe(samples, opt.bpe_model)
